  ...
  render() {
    ...
    <div>        
      ...
      <Paper className={classes.paper}>
        ...
        >
          <BottomNavigationAction label={'Anterior: "'+this.state.anterior+'"'}  onClick = {() => window.location.replace("verE?examen="+this.state.examen+"&pregunta="+this.state.anterior)} icon={ <Icon className={classes.icon}>skip_previous</Icon>  } />
          <BottomNavigationAction label={'Siguiente: "'+this.state.siguiente+'"'} onClick = {() => window.location.replace("verE?examen="+this.state.examen+"&pregunta="+this.state.siguiente)} icon={<Icon className={classes.icon}>skip_next</Icon>} />
