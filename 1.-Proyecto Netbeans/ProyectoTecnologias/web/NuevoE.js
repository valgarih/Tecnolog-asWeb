    ...
    <Paper className={classes.root}>
        ...
        <center>
         <Avatar className={classes.icon}>
            <Icon color="secondary">event_note</Icon>
        </Avatar>
        </center>
      ...
      <Table className={classes.table} >
        <TableHead>
          <TableRow>
            ...
            <CustomTableCell>Seleccion de pregunta</CustomTableCell>
          </TableRow>
        </TableHead>
        <TableBody>
...
const NuevoE = withStyles(styles)(Index);
ReactDOM.render(<NuevoE/>, document.getElementById('root'));
