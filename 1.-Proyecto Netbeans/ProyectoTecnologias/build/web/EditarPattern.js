  ...
  componentDidMount = () => {
      fetch("edicionPregunta.json", {
        ...
        .then( json =>{
            ...
            resp1C:json.PuntajeRespuesta[0],
            resp2:json.textoRespuesta[1],
            resp2C:json.PuntajeRespuesta[1],
            resp3:json.textoRespuesta[2],
            resp3C:json.PuntajeRespuesta[2],
            resp4:json.textoRespuesta[3],
            resp4C:json.PuntajeRespuesta[3],
            resp5:json.textoRespuesta[4],
            resp5C:json.PuntajeRespuesta[4],
            resp6:json.textoRespuesta[5],
            resp6C:json.PuntajeRespuesta[5],
            resp7:json.textoRespuesta[6],
            resp7C:json.PuntajeRespuesta[6],
            resp8:json.textoRespuesta[7],
            resp8C:json.PuntajeRespuesta[7]
      })})
  }
  render() {
     ...
     <div> 
      ...
      <Paper className={classes.paper}>
        <Avatar className={classes.avatar}>
            <Icon className={classes.icon} color="primary">border_color</Icon>
        </Avatar>
        ...
        <Grid container spacing={4}>
            ...
            <Grid container item xs={16} spacing={24} justify="center" alignItems="flex-end">
                <Grid item xs={8}>
                    <FormControl margin="normal"  fullWidth>
                        <InputLabel >Pattern 8</InputLabel>
